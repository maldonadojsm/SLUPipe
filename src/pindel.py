...
class Pindel:
    def __init__(self, tumor_bam, filename, result_directory, chromosome_range):
        """
          Class Constructor
    ...
    def generate_dir(self):
        ...
        """
        os.mkdir(self.result_directory + "vcf/pindel_output/")
    ...
    def bind_inputs(self):
        ...
        self.pindel_read_dict["output"][1] = "./output/" + self.filename + "/vcf/pindel_output/" + self.filename

        # Pindel2VCF
        self.pindel_convert_dict["input"][1] = "./output/" + self.filename + "/vcf/pindel_output/" + self.filename + "_D"
        self.pindel_convert_dict["output"][1] = "./output/" + self.filename + "/vcf/pindel_output/" + self.filename + ".vcf"
