...
scriptDir='/student/maldonadojs/.conda/envs/myenv/share/strelka-2.9.10-0/bin'
scriptName=os.path.basename(__file__)
workflowDir='/student/maldonadojs/.conda/envs/myenv/share/strelka-2.9.10-0/lib/python'
