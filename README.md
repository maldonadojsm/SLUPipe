...
**Reference Files:** Create **referenceFiles** folder in SLUPipe working directory. Place reference .fasta files within this directory.
```console
mkdir referenceFiles
```
**Input Entries:** Create **input** folder within SLUPipe working directory. Place all .bam files to be processed in here (SLUPipe will automate generation of .bai within this directory)
```console
mkdir input
```
**Analysis Results:** Create **output** folder within SLUPipe working directory. Variant calling results generated by SLUPipe will be placed here. Each sample result will have its files organized with the following directory structure:
